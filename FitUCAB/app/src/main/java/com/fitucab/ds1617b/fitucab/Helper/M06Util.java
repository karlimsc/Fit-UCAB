...
/**
 * Created by LuisAlejandro on 03-07-2017.
 */

public class M06Util {
    ...
    private final static String  STATUS_ERROR_ADD="550";
    private final static String  STATUS_ERROR_DELETE="555";
    private final static String  STATUS_ERROR_SHARE="554";
    private final static String  STATUS_ERROR_UPDATE="559";
    ...
    public static boolean checkInsertResponse(User user, Context context){
        ...
        switch (user.get_status()){
            ...
            case STATUS_ERROR_ADD:
                showToast(context,"Ha ocurrido un error agregando");
                return true;

            case STATUS_ERROR_DELETE:
                showToast(context,"Ha ocurrido un error eliminando");
                return true;

            case STATUS_ERROR_SHARE:
                showToast(context,"Ha ocurrido un error compartiendo");
                return true;

            case STATUS_ERROR_UPDATE:
                showToast(context,"Ha ocurrido un error modificando");
                return true;
