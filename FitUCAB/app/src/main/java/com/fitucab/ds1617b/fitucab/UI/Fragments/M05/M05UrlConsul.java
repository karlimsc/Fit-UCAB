 ...
 *
 * Clase que contendra todas las consultas http
 *
 */
...
public class M05UrlConsul {
    ...
    /**
     * Elimina Actividad por id del mismo, se concatena con la id de la actividad
     */
     ...
     * @return  direccion http para la actualizacion
     */
     ...
     * Actualiza Calorias
     * @param id del usuario
     * @param calorias calorias a actualizar
     * @return direccion http para la actualizacion
     */
