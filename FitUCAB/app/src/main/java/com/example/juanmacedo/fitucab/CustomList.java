...
/**
 * Clase para el manejo de la lista de Logros de Gamification.class
 *
...
public class CustomList extends ArrayAdapter<String> {
    ...
    /**
     * Variable para el manejo del contexto de la Actividad Gamification
     */
    private Activity _context;

    /**
     * Constructor de la clase CustomList con todos los parametros de la misma
     * @param _context Variable para el manejo del contexto de la Actividad Gamification
    ...
    public CustomList(Activity _context, String[] _ids, String[] _names, String[] _description,
                      String[] _points) {
        super(_context, R.layout.content, _ids);
    ...
    public View getView(int _position, View _convertView, ViewGroup parent) {
        ...
        View _listViewItem = _inflater.inflate(R.layout.content, null, true);
