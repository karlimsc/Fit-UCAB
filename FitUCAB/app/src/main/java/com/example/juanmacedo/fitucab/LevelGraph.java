...
/**
 * Clase LevelGraph que maneja la actividad del grafico del nivel del Modulo 9 Gestion de Gamificacion
 *
 * @EXTENDS: AppCompatActivity
 * @AUTHORS: Juan Macedo, Cesar Boza, Bryan Teixeira
 * @VERSION: 1.0
 */
public class LevelGraph extends AppCompatActivity {

    //Declaracion de atributos de la clase
    public WebServiceConnections _webService = new WebServiceConnections();
    private String _graphsURL = _webService._dbGetGraphicStats;
    PieChart _pieChart;
    ...
    /**
     * VOID onCreate que genera la actividad LevelGraph
    ...
    private void accomplishmentsJSON(String _json) {
        ...
        try {
            ...
            _accomplished = Integer.parseInt(_jsonObject.getString("Logrado"));
            _notAccomplished = Integer.parseInt(_jsonObject.getString("NoLogrado"));
