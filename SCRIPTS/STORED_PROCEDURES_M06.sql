...
BEGIN
	INSERT INTO TRAINING(TRAININGNAME, FK_PERSONID) VALUES ($1,$2);
...
BEGIN
	INSERT INTO TRAINING_ACTIVITY(TRAINING_ACTIVITYHOURS, FK_TRAININGID, FK_ACTIVITYID) VALUES ($1, $2, $3);
...
BEGIN
	DELETE FROM TRAINING_ACTIVITY WHERE FK_TRAININGID = $1 AND FK_ACTIVITYID =$2;
	result := 1;
 	RETURN result;
END;
$$ LANGUAGE plpgsql;
