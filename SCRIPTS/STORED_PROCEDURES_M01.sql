...
BEGIN
	INSERT INTO person(PERSONUSERNAME, PERSONPASSWORD, PERSONEMAIL, PERSONSEX, PERSONPHONE, PERSONBIRTH) VALUES ($1, $2, $3, $4, $5, $6);
...
CREATE OR REPLACE FUNCTION M01_INFORMACIONUSER(varchar(20)) RETURNS TABLE (id int, usuario varchar(20), pwd varchar(8), mail varchar(30), sex varchar(20), phone varchar(20), birth date, weight real, height real, points int) AS $$

BEGIN
 	RETURN QUERY
	 	SELECT P.PERSONID, P.PERSONUSERNAME, P.PERSONPASSWORD, P.PERSONEMAIL, P.PERSONSEX, P.PERSONPHONE, P.PERSONBIRTH, R.REGISTRYWEIGHT, R.REGISTRYHEIGHT, R.REGISTRYPOINT
