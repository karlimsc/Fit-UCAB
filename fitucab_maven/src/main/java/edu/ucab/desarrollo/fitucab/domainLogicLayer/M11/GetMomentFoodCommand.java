 ...
 */
public class GetMomentFoodCommand extends Command {

    final static org.slf4j.Logger logger = LoggerFactory.getLogger(GetMomentFoodCommand.class);

    Entity _diet;
    public Entity Respuesta;

    public GetMomentFoodCommand(Entity diet) {
    ...
    public void execute() throws ListAllException, ListByIdException, NoSuchMethodException, SQLException, BdConnectException {
        ...
        Respuesta = Daodiet.getMomentFood(_diet);
