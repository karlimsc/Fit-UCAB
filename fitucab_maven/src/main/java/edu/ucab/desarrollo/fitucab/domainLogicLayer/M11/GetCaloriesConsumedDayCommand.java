 ...
 */
public class GetCaloriesConsumedDayCommand extends Command {

    final static org.slf4j.Logger logger = LoggerFactory.getLogger(GetCaloriesConsumedDayCommand.class);

    Entity _diet;
    public Entity Respuesta;

    public GetCaloriesConsumedDayCommand (Entity diet){
        _diet = diet;
    }
    ...
    public void execute() throws ListAllException, ListByIdException, NoSuchMethodException, SQLException, BdConnectException {
        ...
        Respuesta = Daodiet.getCaloriesConsumedDay(_diet);
