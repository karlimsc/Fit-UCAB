 ...
 */
public class GetCaloriesConsumedWeekCommand extends Command {

    final static org.slf4j.Logger logger = LoggerFactory.getLogger(GetCaloriesConsumedWeekCommand.class);

    Entity _diet;
    public Entity Respuesta;

    public GetCaloriesConsumedWeekCommand(Entity diet) {
        _diet = diet;
    }
    ...
    public void execute() throws ListAllException, ListByIdException, NoSuchMethodException, SQLException, BdConnectException {
        ...
        Respuesta = Daodiet.getCaloriesConsumedWeek(_diet);
