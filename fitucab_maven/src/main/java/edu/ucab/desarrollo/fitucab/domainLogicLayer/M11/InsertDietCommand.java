 ...
 */
public class InsertDietCommand extends Command {

    final static org.slf4j.Logger logger = LoggerFactory.getLogger(InsertDietCommand.class);

    Entity _diet;
    public Entity Respuesta;

    public InsertDietCommand(Entity diet){
    ...
    public void execute() throws ListAllException, ListByIdException, NoSuchMethodException, SQLException, BdConnectException {
        ...
        Respuesta = Daodiet.insertDiet(_diet);
